...
import type { UtilToolConfig } from '../config/utilTools'
...
type Props = {
  config: UtilToolConfig
  children: ReactNode
}

export function UtilToolShell({ config, children }: Props) {
      ...
      <main className="tool-main">
        <div className="tool-container">
          <nav className="breadcrumbs" aria-label="Breadcrumb">
            ...
            <Link to="/categories/utilities">{config.category}</Link>
            <ChevronRight size={14} aria-hidden />
