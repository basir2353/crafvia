...
import type { TextToolConfig } from '../config/textTools'
...
export function TextToolShell({ config, children }: Props) {
      ...
      <main className="tool-main">
        <div className="tool-container">
          <nav className="breadcrumbs" aria-label="Breadcrumb">
            ...
            <Link to="/categories/text-tools">{config.category}</Link>
            <ChevronRight size={14} aria-hidden />
...
export function TextOutputActions({
  output,
  onClear,
  disabled,
}: {
