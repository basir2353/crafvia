...
import type { GenToolConfig } from '../config/genTools'
...
export function GenToolShell({ config, children }: Props) {
      ...
      <main className="tool-main">
        <div className="tool-container">
          <nav className="breadcrumbs" aria-label="Breadcrumb">
            ...
            <Link to="/categories/ai-generation">{config.category}</Link>
            <ChevronRight size={14} aria-hidden />
...
export function GenOutputActions({
  output,
  onClear,
  disabled,
