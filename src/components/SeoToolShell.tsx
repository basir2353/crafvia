...
import type { SeoToolConfig } from '../config/seoTools'
...
type Props = {
  config: SeoToolConfig
  children: ReactNode
}

export function SeoToolShell({ config, children }: Props) {
      ...
      <main className="tool-main">
        <div className="tool-container">
          <nav className="breadcrumbs" aria-label="Breadcrumb">
            ...
            <Link to="/categories/seo-tools">{config.category}</Link>
            <ChevronRight size={14} aria-hidden />
...
export function SeoOutputActions({
  output,
  onClear,
  disabled,
