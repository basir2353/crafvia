...
import type { AudioToolConfig } from '../config/audioTools'
import { whyCrafvia } from '../config/tools'
import type { AudioMetadata } from '../utils/audioInfo'
import { formatDuration } from '../utils/audioInfo'
      ...
      <main className="tool-main">
        <div className="tool-container">
          <nav className="breadcrumbs" aria-label="Breadcrumb">
            ...
            <Link to="/categories/audio-tools">{config.category}</Link>
            <ChevronRight size={14} aria-hidden />
          ...
          <div className="upload-outer">
            ...
            {selectedFile && metadata && (
              <div className="tool-controls">
                <label className="tool-control-label">Audio information</label>
            ...
            {showResultPreview && (
              <div className="tool-preview">
                <audio src={resultPreviewUrl} controls preload="metadata" />
              </div>
            )}
